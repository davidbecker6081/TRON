...
$normalBtn.on('click', () => fps = 20)
$hardBtn.on('click', () => fps = 30)
...
function countDownStart() {
  if (countDownNum > 0) {
    contextOverlay.strokeText(`${countDownNum}`, canvasOverlay.width/2 - 20, canvasOverlay.height/2)
    countDownNum--;
    ...
    console.log('countDownNum less than 0')
    isGamePaused = false
    countdownFinish = true;
    gameStart = true
    hideCanvasOverlay()
